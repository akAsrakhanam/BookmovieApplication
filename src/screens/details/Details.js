/*
 * it Displays the details of the movie along with its trailer video when the released movie 
 * title is clicked in the home page. This page also allows the user to book a show of the same movie
 */
